...
The numerical value carried by each unit must be unitized, i.e., expressed as an integer multiple greater than 1 of the basic unit.In other words, the value carried by any unit is a positive integer.
